define(['utils/appFunc',
    ...
    var xhr = {
        ...
        //webServerAddress : "http://localhost/tpaas",
        //webServerAddress : "http://tpm.onecc.me/tpaas",
        config:{
            "createaCtrl_VMR":             "/currentuser/tenant/vmrs/idle",
            "vmrCtrl_VMRS":                "/currentuser/tenant/vmrs",
            "vmrCtrl_history":             "/currentuser/conference/history",
            "vmrCtrl_active":              "/currentuser/conference/active",
            "user_login":                  "/login",
            "currentuser":                 "/currentuser",
            "sessionTouch":                "/session/touch",
            "createMeeting":               "/currentuser/conference",
            "changeMeeting":               "/conference/{{id}}",
            "createbCtrl_addUser":         "/currentuser/personal/contact",
            "createbCtrl_addTerminals":    "/conference/{{id}}/terminal",
            "createbCtrl_status":          "/currentuser/all/contacts/status",
            "createbCtrl_top":             "/currentuser/recent/contacts",
            "log-out":                     "/logout",
            "contactsAll":                 "/currentuser/all/contacts",
            "contactsAllStatus":           "/currentuser/all/contacts/status",
            "contactsTop":                 "/currentuser/recent/contacts",
            "appCtrl_going":               "/currentuser/conference/going",
            "vmrCtrl_going":               "/currentuser/conference/going",
            "appCtrl_meetingStatus":       "/conference/{{id}}/status",
            "appCtrl_history":             "/currentuser/conference/history",
            "appCtrl_all":                 "/currentuser/conference/active",
            "active_delete":               "/conference/{{id}}",
            "historyCtrl_going":           "/currentuser/conference/going",
            "historyCtrl_history":         "/currentuser/conference/history",
            "historyCtrl_active":         "/currentuser/conference/active",
        ...
        simpleCall: function(options,callback,error){
            ...
            //增加版本号 
            options.headers.Accept = options.headers.Accept || "application/json; version=2.0"
            //
